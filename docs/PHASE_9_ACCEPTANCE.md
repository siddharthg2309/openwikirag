...
| Bounded summary | latest six validated messages, 2,000 UTF-8 byte cap; provider-context assertions | Implemented; dedicated maximum-Unicode boundary proof still needed |
